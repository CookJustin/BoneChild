...
public class Projectile {
    private Animation animation; // Projectile manages its own animation
    ...
    public Projectile(float startX, float startY, float targetX, float targetY, float damage, boolean isCritical, Animation animation) {
